...
/**
 * **Warning** This is a non-standard tile matrix for `EPSG:32703`.
 *
 * Created using `packages/shared/src/scripts/debug.tile.matrix.ts`
 */
const Utm3sTmst: TileMatrixSetType & { $generated: unknown; $options: unknown } = {
  type: 'TileMatrixSetType',
  title: 'Debug tile matrix for EPSG:32703',
  identifier: 'UTMzone3S',
  boundingBox: {
    type: 'BoundingBoxType',
    crs: 'https://www.opengis.net/def/crs/EPSG/0/32703',
    lowerCorner: [-4509377.085697294, 562865.6955643315],
    upperCorner: [5509377.085697294, 10581619.86695892],
  },
  supportedCRS: 'https://www.opengis.net/def/crs/EPSG/0/32703',
  tileMatrix: [
    {
      type: 'TileMatrixType',
      identifier: '0',
  ...
  $generated: {
    ...
    createdAt: '2025-07-24T20:38:21.141Z',
  },
  $options: {
...
export const Utm3sTms = new TileMatrixSet(Utm3sTmst);
