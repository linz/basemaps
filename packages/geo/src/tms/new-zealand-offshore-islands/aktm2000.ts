...
/**
 * **Warning** This is a non-standard tile matrix for `EPSG:3788`.
 *
 * Created using `packages/shared/src/scripts/debug.tile.matrix.ts`
 */
const Aktm2000Tmst: TileMatrixSetType & { $generated: unknown; $options: unknown } = {
  type: 'TileMatrixSetType',
  title: 'Debug tile matrix for EPSG:3788',
  identifier: 'AKTM2000Quad',
  boundingBox: {
    type: 'BoundingBoxType',
    crs: 'https://www.opengis.net/def/crs/EPSG/0/3788',
    lowerCorner: [4205543.986579382, 3204311.093337269],
    upperCorner: [4831716.122291545, 3830483.2290494326],
  },
  supportedCRS: 'https://www.opengis.net/def/crs/EPSG/0/3788',
  tileMatrix: [
    {
      type: 'TileMatrixType',
      identifier: '0',
      scaleDenominator: 8735660.37544871,
      topLeftCorner: [4831716.122291545, 3204311.093337269],
      tileWidth: 256,
      tileHeight: 256,
      matrixWidth: 1,
      matrixHeight: 1,
  ...
  $generated: {
    ...
    createdAt: '2025-07-24T22:41:04.128Z',
  },
  $options: {
...
export const Aktm2000Tms = new TileMatrixSet(Aktm2000Tmst);
