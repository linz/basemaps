...
/**
 * **Warning** This is a non-standard tile matrix for `EPSG:3789`.
 *
 * Created using `packages/shared/src/scripts/debug.tile.matrix.ts`
 */
const Catm2000Tmst: TileMatrixSetType & { $generated: unknown; $options: unknown } = {
  type: 'TileMatrixSetType',
  title: 'Debug tile matrix for EPSG:3789',
  identifier: 'CATM2000Quad',
  boundingBox: {
    type: 'BoundingBoxType',
    crs: 'https://www.opengis.net/def/crs/EPSG/0/3789',
    lowerCorner: [4136869.8234775513, 3469344.3492567954],
    upperCorner: [4215141.340441572, 3547615.8662208156],
  },
  supportedCRS: 'https://www.opengis.net/def/crs/EPSG/0/3789',
  tileMatrix: [
    {
      type: 'TileMatrixType',
      identifier: '0',
      scaleDenominator: 1091957.54693108,
      topLeftCorner: [4215141.340441572, 3469344.3492567954],
      tileWidth: 256,
      tileHeight: 256,
      matrixWidth: 1,
      matrixHeight: 1,
  ...
  $generated: {
    ...
    createdAt: '2025-07-24T22:40:46.896Z',
  },
  $options: {
...
export const Catm2000Tms = new TileMatrixSet(Catm2000Tmst);
