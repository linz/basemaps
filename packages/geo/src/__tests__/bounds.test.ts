...
o.spec('Bounds', () => {
  ...
  o('union', () => {
    ...
    o(new Bounds(5, 10, 6, 7).union(new Bounds(2, 2, 20, 20)).toJson()).deepEquals(new Bounds(2, 2, 20, 20).toJson());

    o(new Bounds(2, 2, 20, 20).union(new Bounds(5, 10, 6, 7)).toJson()).deepEquals(new Bounds(2, 2, 20, 20).toJson());
  });
