...
o.spec('Projection', () => {
    ...
    o('should parseEpsgString', () => {
        ...
        o(Projection.parseEpsgString('NZTM_2000')).equals(EPSG.Nztm);
        ...
        o(Projection.parseEpsgString('citm_2000')).equals(EPSG.Citm);
        o(Projection.parseEpsgString('citm')).equals(EPSG.Citm);
        o(Projection.parseEpsgString('epsg:3793')).equals(EPSG.Citm);
        o(Projection.parseEpsgString('3793')).equals(EPSG.Citm);
    });
