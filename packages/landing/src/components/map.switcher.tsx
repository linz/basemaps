...
export class MapSwitcher extends Component {
  ...
  getStyleType(): { layerId: string; style?: string } {
    if (Config.map.layerId === 'aerial') {
      return { layerId: 'topographic', style: 'topographic-v2' };
    } else if (Config.map.layerId === 'topographic' && Config.map.style === 'topographic-v2') {
      return { layerId: 'topo-raster', style: 'topo-raster' };
    } else if (Config.map.layerId === 'topo-raster') {
      return { layerId: 'topographic', style: 'topolite-v2' };
    } else if (Config.map.layerId === 'topographic' && Config.map.style === 'topolite-v2') {
