      ...
      <div className="debug">
        <div className="debug__info">
          <label className="debug__label">
            <div className="debug__value">ImageId: {Config.map.layerId}</div>
          </label>
        </div>
        <div className="debug__info">
          <label className="debug__label">
            <div className="debug__value">Projection: {Config.map.tileMatrix.projection.toEpsgString()}</div>
          </label>
        </div>
        <div className="debug__info">
          <label className="debug__label">
            <div className="debug__value">TileMatrix: {Config.map.tileMatrix.identifier}</div>
          </label>
        </div>
        <div className="debug__info">
          <label className="debug__label">
            <div className="debug__value">OSM:</div>
          </label>
          <input className="osm__slider" type="range" min="0" max="1" step="0.05" value="0" onInput={this.adjustOSM} />
        </div>
        <div className="debug__info">
          <label className="debug__label">
            <div className="debug__value">Purple:</div>
          </label>
